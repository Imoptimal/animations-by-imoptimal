...
2. Unzip it and upload the folder imoptimal-animations to the /wp-content/plugins/ directory.
...
5. Collapsible Animation group options section in the settings page
...
Animations by Imoptimal is distributed under the terms of the GNU GPL
