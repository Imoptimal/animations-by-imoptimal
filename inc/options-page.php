...
<div id="imo-options" class="imo-wrap">
    ...
    <ol class="imo-list">
        ...
        <li>2. <?php esc_html_e('Select the type of animation for that group of items.', 'imoptimal'); ?></li>
        ...
        <li><?php esc_html_e('Use the preview button to check all of the choosen options in action.', 'imoptimal'); ?></li>
    </ol>
